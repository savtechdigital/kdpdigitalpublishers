...
const dummyBlogs = [
  {
    ...
    excerpt: "A Guide to Book Publishing Seasons. Timing is everything when it comes to publishing a book, but most times, authors get it wrong. Too many writers assume a great book will sell no matter when it's released. Spoiler alert: that's not how it works.",
    category: "Book Publishing",
    date: "2024-04-05",
    image: "https://res.cloudinary.com/dncqhipqk/image/upload/v1744044418/17_srrp4y.png",
    author: {
      name: "John Smith",
      avatar: "https://res.cloudinary.com/dncqhipqk/image/upload/v1744045718/4_tvwsui.png"
    }
  },
  {
    id: 2,
    title: "Why Book Formatting Services Are Important",
    excerpt: "Why Book Formatting Services Are Important for Your Manuscript's Success. Any published manuscript is bound to get tossed aside, no matter how brilliant the analogy of your content is.",
    category: "Book Formatting",
    date: "2024-04-02",
    image: "https://res.cloudinary.com/dncqhipqk/image/upload/v1744045756/4_q1m5uj.webp",
    author: {
      name: "Emma Wilson",
      avatar: "https://res.cloudinary.com/dncqhipqk/image/upload/v1744045718/4_tvwsui.png"
    }
  },
  {
    ...
    excerpt: "Stand Out? A Guide for Writers & Readers You have all the tools, passion, and storytelling abilities you need, to craft something spectacular but the question still lingers 'How do I turn all of this into something that grabs the audience's attention?'",
  ...
  },
  {
    ...
    excerpt: "As a self-publishing author, you've likely experienced the agony of opening an eBook and being assaulted by eye-straining fonts that make you want to throw your device across the room.",
    category: "eBooks",
    date: "2024-03-28",
    image: "https://res.cloudinary.com/dncqhipqk/image/upload/v1744044418/17_srrp4y.png",
    author: {
...
const categories = ["All", "Book Publishing", "Book Formatting", "Writing Tips", "eBooks", "Marketing"];
...
const Blogs = () => {
  ...
  const filterBlogs = () => {
    ...
    if (selectedCategory !== "All") {
      filtered = dummyBlogs.filter(blog => blog.category === selectedCategory);
    }
  ...
  return (
    ...
    >
      ...
      >
        <div className="container mx-auto px-4 p-20 text-white">
          <motion.div
            variants={childVariants}
            ...
            {currentBlogs.length > 0 ? (
              ...
              >
                ...
                <p className="text-gray-500 text-center max-w-md">
                  No blog posts were found for the selected category. Please try another category or check back later.
                </p>
                <motion.button
                  variants={childVariants}
                  whileHover={{ scale: 1.05 }}
