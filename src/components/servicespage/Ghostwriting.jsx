          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <motion.p
                ...
                className="text-gray-700"
              >
               With the help of ghostwriting, your ideas will make perfect content. A good ghostwriter has the expertise to turn your story into a professional piece that feels authentically yours. From research to revisions, they do it all. This way, you get the free time to focus on other things. A ghostwriter will help you write the content in such a manner that relates to your audience and brings your ideas to life within a blink.
        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="flex flex-col md:flex-row items-center justify-center gap-12 max-w-7xl mx-auto">
            ...
            >
              ...
              Hiring a quality ghostwriter can play a major role in bringing your ideas to life. Are you an aspiring novelist or someone who wants to tell a story but never gets time to sit and write it down? The ghost takes your ideas, voice, and vision and delivers them as a complete package. A ghostwriter will definitely bring knowledge and insight to your project. This is why a lot of people go this route.
              ...
              <div className="mb-8">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Time-Saving Expertise:</h3>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2">•</span>
                    <span> Ghostwriters take care of research, writing, and editing. It leaves you with the time to indulge in what really interests you.
                    </span>
                  </li>
              ...
              <div className="mb-8">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2">•</span>
                    <span>A ghostwriter gets your story polished and presents it in such a way goes beyond the standards of the industry.</span>
                  </li>
                  
                </ul>
              </div>
              <div className="mb-8">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Customized Voice: </h3>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2">•</span>
                    <span>They represent your unique tone and perspective to ensure the content feels as if you produced it.</span>
                  </li>
                  
                </ul>
              </div>
              <div className="mb-8">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Confidentiality Guaranteed:  </h3>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2">•</span>
                    <span>You get the full credit of your work hile the confidentiality is maintained. This way, an author gets all the benefits of a ghostwriter.</span>
                  </li>
                  
                </ul>
              </div>
              <div className="mb-8">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Wide Range of Genres and Styles:  </h3>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <span className="text-orange-500 mr-2">•</span>
                    <span>Ghostwriters have their niches. They can write anything from business books to fictions.</span>
                  </li>
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-sm">
                      Share your journey, challenges, and triumphs. Readers love
                      connecting with real people behind the stories they love.
                      Show off your personality and let them see the writer
                      behind the words.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-sm">
                      Eye-catching images and videos perform better than
                      anything. Use your book cover or short reels to highlight
                      your book's themes. Add captions that spark curiosity and
          ...
          >
            ...
            <p className="text-gray-600 max-w-5xl text-sm mx-auto mb-8">
              At KDP, we combine creativity with our passion to make your book
              stand out in a crowded marketplace. This way, we design a
              marketing journey that not only sells books but also creates a
              meaningful connection with your audience. Let’s get started!
            </p>
